...
with(this){return _c('ul',[_c('li',[_v("Some tests and functional code was written with the help of "),_c('a',{attrs:{"href":"https://github.com/features/copilot"}},[_v("Github Copilot")]),_v(" autocomplete")]),_v(" "),_c('li',[_v("Address book app built upon "),_c('a',{attrs:{"href":"https://se-education.org/addressbook-level3/"}},[_v("AB3")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The filter mechanism is facilitated by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FilterCommand")]),_v(". It allows users to filter the contact list based on names and/or tags. The feature is implemented using predicates that check for matches in both the contact names and tags.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Step 4. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" to show all contacts again, removing any active filters.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The following sequence diagram shows how the filter operation works through the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" component:")])}
},function anonymous(
) {
...
with(this){return _c('h5',{attrs:{"id":"aspect-how-filter-matching-is-performed"}},[_v("Aspect: How filter matching is performed"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#aspect-how-filter-matching-is-performed","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice)")]),_v(": Matches name by containment and tags by exact match")]),_v(" "),_c('ul',[_c('li',[_v("Pros: More flexible name matching allows partial matches")]),_v(" "),_c('li',[_v("Cons: May return unintended matches for short name queries")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2")]),_v(": Exact matching for both names and tags")]),_v(" "),_c('ul',[_c('li',[_v("Pros: More precise results")]),_v(" "),_c('li',[_v("Cons: Users need to type exact names, which is less convenient")])])])])}
},function anonymous(
) {
with(this){return _c('h5',{attrs:{"id":"aspect-handling-multiple-filter-criteria"}},[_v("Aspect: Handling multiple filter criteria"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#aspect-handling-multiple-filter-criteria","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice)")]),_v(": AND operation between name and tags, AND between multiple tags")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Returns more focused results")]),_v(" "),_c('li',[_v("Cons: May return empty results if criteria are too strict")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2")]),_v(": OR operation between all criteria")]),_v(" "),_c('ul',[_c('li',[_v("Pros: More likely to return results")]),_v(" "),_c('li',[_v("Cons: May return too many unrelated results")])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"tagging-duplicate-phone-numbers"}},[_v("Tagging Duplicate Phone Numbers"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#tagging-duplicate-phone-numbers","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The detection and tagging of duplicate phone numbers mechanism is facilitated by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DuplicatePhoneTagger")]),_v(". It tracks duplicate phone numbers across all persons in the address book and automatically tags persons who share the same phone number with a \"DuplicatePhone\" tag. This mechanism is integrated into commands that can modify a person's phone number or the entire list, such as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DuplicatePhoneTagger")]),_v(" implements the following key operations:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DuplicatePhoneTagger#updateFrequenciesOfPhones()")]),_v(" — Counts and stores the frequency of each phone number")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DuplicatePhoneTagger#updatePersonsList()")]),_v(" — Updates the tags of all persons based on whether their phone numbers are duplicates")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DuplicatePhoneTagger#tagPhoneDuplicates()")]),_v(" — Main method that coordinates the duplicate phone tagging process")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Assume the address book has two persons: Alex (phone: 87654321) and Bob (phone: 91234567). With Alex being the 1st entry in the address book and Bob being the 2nd.")])]),_v(" "),_c('li',[_c('p',[_v("The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 2 p/87654321")]),_v(" to change Bob's phone number to match Alex's.")])]),_v(" "),_c('li',[_c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit")]),_v(" command first creates the modified person with the new phone number.")])]),_v(" "),_c('li',[_c('p',[_v("After the person is edited, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DuplicatePhoneTagger#tagPhoneDuplicates()")]),_v(" is called. This updates the frequency count of all phone numbers and identifies that \"87654321\" appears twice.")])]),_v(" "),_c('li',[_c('p',[_v("Finally, both Alex and Bob are tagged with the \"DuplicatePhone\" tag since they share the same phone number.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_v("The following sequence diagrams show how the detection of duplicate phone numbers is carried out in the case of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit")]),_v(" operation being executed.")])}
},function anonymous(
) {
...
with(this){return _c('h5',{attrs:{"id":"aspect-when-to-perform-duplicate-phone-tagging"}},[_v("Aspect: When to perform duplicate phone tagging"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#aspect-when-to-perform-duplicate-phone-tagging","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Perform tagging after any command that could modify phone numbers")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Ensures tags are always up-to-date")]),_v(" "),_c('li',[_v("Cons: May have slight performance impact for commands that modify multiple persons")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Only check for duplicates when explicitly requested")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Better performance as checking is done on-demand")]),_v(" "),_c('li',[_v("Cons: Tags could become outdated if users forget to run the check")])])])])}
},function anonymous(
) {
with(this){return _c('h5',{attrs:{"id":"aspect-storage-of-phone-number-frequencies"}},[_v("Aspect: Storage of phone number frequencies"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#aspect-storage-of-phone-number-frequencies","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Use a HashMap to store phone frequencies")]),_v(" "),_c('ul',[_c('li',[_v("Pros: O(1) lookup time for checking duplicates")]),_v(" "),_c('li',[_v("Cons: Additional memory usage to maintain the HashMap")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Check for duplicates by scanning the person list")]),_v(" "),_c('ul',[_c('li',[_v("Pros: No additional data structures needed")]),_v(" "),_c('li',[_v("Cons: O(n²) time complexity for checking duplicates")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("salespeople who make recurring sales")]),_v(" "),_c('li',[_v("has a need to manage a significant number of contacts")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")]),_v(" "),_c('li',[_v("frequently uses contacts for work (business)")]),_v(" "),_c('li',[_v("has a need to manage multiple pieces of information about each contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("manage contacts faster than a typical mouse/GUI driven app")]),_v(" "),_c('li',[_v("prioritise contacts for scheduling and work efficiency")]),_v(" "),_c('li',[_v("consolidates many different pieces of information about contacts")]),_v(" "),_c('li',[_v("get an overview of all contacts easily")]),_v(" "),_c('li',[_v("can search and filter for specific types or pieces of information quickly")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("new user")]),_v(" "),_c('td',[_v("see usage instructions")]),_v(" "),_c('td',[_v("refer to instructions when I forget how to use the App")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("add a new person")]),_v(" "),_c('td',[_v("keep my contact list up to date")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("delete a person")]),_v(" "),_c('td',[_v("remove entries that I no longer need")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("find a person by name")]),_v(" "),_c('td',[_v("locate details of persons without having to go through the entire list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user with clients who need prioritization")]),_v(" "),_c('td',[_v("filter clients by contract value or last contact")]),_v(" "),_c('td',[_v("identify clients that need attention to hit my KPIs")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user with many clients")]),_v(" "),_c('td',[_v("filter persons by tags")]),_v(" "),_c('td',[_v("locate persons by category without having to go through the entire list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user who handles client renewals")]),_v(" "),_c('td',[_v("filter clients by renewal date")]),_v(" "),_c('td',[_v("focus on those whose contracts are renewing soon")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user with many clients")]),_v(" "),_c('td',[_v("export contacts to csv")]),_v(" "),_c('td',[_v("share address books")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user with busy schedules")]),_v(" "),_c('td',[_v("sort persons by priority metrics")]),_v(" "),_c('td',[_v("prioritize the most critical clients easily")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user with many persons in the address book")]),_v(" "),_c('td',[_v("sort persons by name")]),_v(" "),_c('td',[_v("locate a person easily")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("stressed admin personnel")]),_v(" "),_c('td',[_v("access quick help")]),_v(" "),_c('td',[_v("get command assistance without losing time when I forget the commands")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add person")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a input form for person's details")])]),_v(" "),_c('li',[_c('p',[_v("User enters person details like name, phone number, email, tags etc")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook validates user input")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook saves the person")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("4a. The user input is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("4a1. AddressBook shows an error message.")]),_v(" "),_c('li',[_v("4a2. AddressBook requests for the correct data.")]),_v(" "),_c('li',[_v("4a3. User enters new data.")]),_v(" "),_c('li',[_v("Steps 4a1-4a2 are repeated until the data entered are correct.")]),_v(" "),_c('li',[_v("Use case resumes at step 5.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Filter by tag")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to filter persons by tag")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a input search bar")])]),_v(" "),_c('li',[_c('p',[_v("User enters input related to key of a tag")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of persons with matching tag key")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("4a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Advanced Filter by Tag")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to advanced filter persons by tag")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a input search bar")])]),_v(" "),_c('li',[_c('p',[_v("User enters input related to a key, an operator and a value of a tag")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of persons with tags matching the criterion")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: Export to CSV")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to export file to CSV")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook opens file manager for user to choose destination directory")])]),_v(" "),_c('li',[_c('p',[_v("User enters destination directory and file name")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook outputs list of persons to CSV file in corresponding destination")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook opens destination directory containing CSV file")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. AddressBook is unable to open file manager.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. AddressBook shows an error message.\nUse case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" without requiring any further installation or additional platform-specific dependencies")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 persons without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("Should automatically save changes to the local data file, and it should be able to recover from unexpected shutdowns or power failures without data loss.")]),_v(" "),_c('li',[_v("Should have a responsive and intuitive user interface that works well across different screen resolutions (1920 x 1080 or higher).")]),_v(" "),_c('li',[_v("Should be easy to use and provide clear instructions and feedback to the user for common tasks like adding, editing, filtering, and exporting contacts.")]),_v(" "),_c('li',[_v("Should be designed to accommodate future growth in the number of persons and additional features without major rewriting of code.")]),_v(" "),_c('li',[_v("Should be modular and easy to test.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Command-line Interface (CLI)")]),_v(": A text-based user interface where the user interacts with the application by typing commands, as opposed to a Graphical User Interface (GUI).")]),_v(" "),_c('li',[_c('strong',[_v("Typical Usage")]),_v(": The expected day-to-day usage of the application by the target user, which should not cause significant performance degradation.")]),_v(" "),_c('li',[_c('strong',[_v("Above-average Typing Speed")]),_v(": A typing speed that is higher than the average user (40 words per minute), allowing the user to input commands and data more efficiently.")]),_v(" "),_c('li',[_c('strong',[_v("Platform-specific dependencies")]),_v(":  Additional software required to run the application due to differences in Mainstream OS.")]),_v(" "),_c('li',[_c('strong',[_v("Local data file")]),_v(": File stored on and only on the user's computer/device running the application.")]),_v(" "),_c('li',[_c('strong',[_v("Sensitive Data")]),_v(": Data in any form (often text) that may harm the user or persons if exposed to unwanted parties (e.g. financial data, credit card info)")]),_v(" "),_c('li',[_c('strong',[_v("File Manager")]),_v(": OS-specific software that allows user to view and manage (create, delete etc) files on their computer/device. Often comes pre-installed as part of the OS.")]),_v(" "),_c('li',[_c('strong',[_v("CSV")]),_v(": Type of format of file that stores data in an ordered fashion using rows and columns. Often used in third-party spreadsheet software such as Microsoft Excel.")]),_v(" "),_c('li',[_c('strong',[_v("Tag")]),_v(": Form of text-based labelling to categorise persons or data for organisation.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_c('strong',[_v("Initial launch")])]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Download the jar file and copy into an empty folder")])]),_v(" "),_c('li',[_c('p',[_v("Double-click the jar file Expected: Shows the GUI with a set of sample contacts. The window size may not be optimum.")])])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Saving window preferences")])]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Resize the window to an optimum size. Move the window to a different location. Close the window.")])]),_v(" "),_c('li',[_c('p',[_v("Re-launch the app by double-clicking the jar file."),_c('br'),_v("\nExpected: The most recent window size and location is retained.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_c('strong',[_v("Deleting a person while all persons are being shown")])]),_v(" "),_c('ol',[_c('li',[_c('p',[_c('strong',[_v("Prerequisites:")]),_v(" List all persons using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple persons in the list.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Test case:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 1")]),_c('br'),_v("\nExpected: First contact is deleted from the list. Details of the deleted contact shown in the status message. Timestamp in the status bar is updated.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Test case:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 0")]),_c('br'),_v("\nExpected: No person is deleted. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Other incorrect delete commands to try:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is larger than the list size)"),_c('br'),_v("\nExpected: Similar to previous.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_c('strong',[_v("Clear all contacts")])]),_v(" "),_c('ol',[_c('li',[_c('p',[_c('strong',[_v("Prerequisites:")]),_v(" Add at least one person to the address book.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Test case:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clear")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Expected:")]),_v(" All contacts are removed from the list")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"adding-a-person-including-a-duplicate-phone-case"}},[_v("Adding a person (including a duplicate phone case)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#adding-a-person-including-a-duplicate-phone-case","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_c('strong',[_v("Add a person normally")])]),_v(" "),_c('ol',[_c('li',[_c('p',[_c('strong',[_v("Test case:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n\\Jane Doe p\\98765432 e\\janedoe@example.com a\\123 Maple Street fi\\middleClass s\\@janeDoe t\\friends:4 t\\priority:3 t\\client")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Expected:")]),_v(" Jane Doe is added to the address book with specified details and tags. The UI shows the updated contact list.")])])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Add a person with the same phone number (duplicatePhoneTagger)")])]),_v(" "),_c('ol',[_c('li',[_c('p',[_c('strong',[_v("Prerequisites:")]),_v(" Jane Doe already exists in the address book.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Test case:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n\\John Smith p\\98765432 e\\johnsmith@example.com a\\45 Elm Road fi\\highIncome s\\@johnSmith t\\friends:5 t\\priority:2")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Expected:")]),_v(" John Smith is added, but a label (duplicatePhoneTagger) appears in the UI indicating that a duplicate phone number is present.")])])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Add an additional person normally, for the later parts of testing")])]),_v(" "),_c('ol',[_c('li',[_c('p',[_c('strong',[_v("Test case:")]),_v(": "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n\\Tim Jobs p\\98222432 e\\timjo@example.com a\\1 Infinity Loop fi\\billionaire s\\@tJobs t\\friends:7 t\\priority:1 t\\client")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Expected:")]),_v(" Tim Jobs is added to the address book with specified details and tags. The UI shows the updated contact list.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"filtering-contacts"}},[_v("Filtering contacts"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#filtering-contacts","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_c('strong',[_v("Filter by a single tag")])]),_v(" "),_c('ol',[_c('li',[_c('p',[_c('strong',[_v("Prerequisites:")]),_v(" Add at least two contacts with different tags.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Test case:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter t\\client")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Expected:")]),_v(" The list shows only contacts tagged as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("client")]),_v(".")])])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Filter by name and tag")])]),_v(" "),_c('ol',[_c('li',[_c('p',[_c('strong',[_v("Test case:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter n\\Jane t\\client")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Expected:")]),_v(" The list shows contacts whose name contains \"Jane\" and who have the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("client")]),_v(" tag.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"advanced-filtering-of-contacts-advfilter"}},[_v("Advanced Filtering of contacts (advfilter)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#advanced-filtering-of-contacts-advfilter","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_c('strong',[_v("Filter with a comparison operator on tags with values")])]),_v(" "),_c('ol',[_c('li',[_c('p',[_c('strong',[_v("Prerequisites:")]),_v(" At least one contact with a tag that has a numeric value (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("t\\friends:4")]),_v(").")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Test case:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("advfilter t\\friends > 4")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Expected:")]),_v(" The list displays only contacts with a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("friends")]),_v(" tag greater than 4.")])])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Filter with equality on tags with specific values")])]),_v(" "),_c('ol',[_c('li',[_c('p',[_c('strong',[_v("Test case:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("advfilter t\\priority = 3")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Expected:")]),_v(" Only contacts with a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority")]),_v(" tag set to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("3")]),_v(" are displayed.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"sorting-contacts"}},[_v("Sorting contacts"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#sorting-contacts","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_c('strong',[_v("Sort contacts by tag values in ascending order")])]),_v(" "),_c('ol',[_c('li',[_c('p',[_c('strong',[_v("Prerequisites:")]),_v(" At least two contacts with a tag that has a value (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("t\\friends:5")]),_v(").")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Test case:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort t\\friends asc")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Expected:")]),_v(" Contacts are sorted in ascending order by the value of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("friends")]),_v(" tag.")])])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Sort contacts by tag values in descending order")])]),_v(" "),_c('ol',[_c('li',[_c('p',[_c('strong',[_v("Test case:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort t\\priority desc")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Expected:")]),_v(" Contacts are sorted in descending order by the value of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority")]),_v(" tag.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_c('strong',[_v("Export contact list to a file")])]),_v(" "),_c('ol',[_c('li',[_c('p',[_c('strong',[_v("Prerequisites:")]),_v(" Have a list of contacts available to export.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Test case:")]),_v(" Run the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export format\\csv")]),_v(" command")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Expected:")]),_v(" Contacts are exported to a file in CSV format. Verify that all contact details are present in the file.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_c('strong',[_v("Dealing with missing/corrupted data files")])]),_v(" "),_c('ol',[_c('li',[_c('p',[_c('strong',[_v("Prerequisites:")]),_v(" BA€ is not running")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Test case:")])]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("To simulate a corrupted file, navigate to the data folder, and find bae_addressbook.json")])]),_v(" "),_c('li',[_c('p',[_v("Delete bae_addressbook.json")])]),_v(" "),_c('li',[_c('p',[_v("Launch BA€.")])])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Expected:")]),_v(" A new addressbook.json file will be created and it will be empty.")])])])])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Sun, 10 Nov 2024, 14:44:41 GMT+8]")])])])}
}];
